...
export function AppProvider({ children }) {
  ...
  useEffect(() => {
    if (profile?.email) {
      ...
      fetch('https://script.google.com/macros/s/AKfycby_ki8cx1_LhpISCCmltuC8Eu6yWKM1CemxtCFbZMjmpNz7zGqzyXpLHB75l3ypUEw/exec', {
      ...
      const handleBeforeUnload = () => {
        ...
        try {
          const url = 'https://script.google.com/macros/s/AKfycby_ki8cx1_LhpISCCmltuC8Eu6yWKM1CemxtCFbZMjmpNz7zGqzyXpLHB75l3ypUEw/exec'
  ...
  const fetchSyncedTasks = async () => {
    ...
    try {
      const url = `https://script.google.com/macros/s/AKfycby_ki8cx1_LhpISCCmltuC8Eu6yWKM1CemxtCFbZMjmpNz7zGqzyXpLHB75l3ypUEw/exec?action=get_tasks&t=${Date.now()}`
      const res = await fetch(url)
  ...
  const fetchTeam = async () => {
    ...
    try {
      const url = `https://script.google.com/macros/s/AKfycby_ki8cx1_LhpISCCmltuC8Eu6yWKM1CemxtCFbZMjmpNz7zGqzyXpLHB75l3ypUEw/exec?action=get_team&t=${Date.now()}`
      const res = await fetch(url)
  ...
  const fetchClients = async () => {
    try {
      const url = `https://script.google.com/macros/s/AKfycby_ki8cx1_LhpISCCmltuC8Eu6yWKM1CemxtCFbZMjmpNz7zGqzyXpLHB75l3ypUEw/exec?action=get_clients&t=${Date.now()}`
      const res = await fetch(url)
  ...
  const fetchActivities = async () => {
    try {
      const url = `https://script.google.com/macros/s/AKfycby_ki8cx1_LhpISCCmltuC8Eu6yWKM1CemxtCFbZMjmpNz7zGqzyXpLHB75l3ypUEw/exec?action=get_activities&t=${Date.now()}`
      const res = await fetch(url)
      if (res.ok) {
        const text = await res.text()
        try {
