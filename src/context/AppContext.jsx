...
export function AppProvider({ children }) {
  ...
  const handlePunchIn = () => {
    ...
    const DAILY_SHEET_WEB_APP_URL = 'https://script.google.com/macros/s/AKfycbyUskDKzhQHsfQmdXVXV0O9AT6DxoSfoKgH0mR3bECnOCDEBCMHsBm-rukpB-7Jubvo/exec';
  ...
  const handlePunchOut = () => {
    ...
    if (prevEmail) {
      const DAILY_SHEET_URL = 'https://script.google.com/macros/s/AKfycbyUskDKzhQHsfQmdXVXV0O9AT6DxoSfoKgH0mR3bECnOCDEBCMHsBm-rukpB-7Jubvo/exec';
