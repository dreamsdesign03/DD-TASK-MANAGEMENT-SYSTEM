...
export function AppProvider({ children }) {
  ...
  const handlePunchIn = () => {
    ...
    const DAILY_SHEET_WEB_APP_URL = 'https://script.google.com/macros/s/AKfycbwmjTPG-wuYFnmx4RMZAGN21ujZ7j-X5aPVes5pmG8YkNPmvgNLcaXPGaHmr8e37uWx8g/exec';
  ...
  useEffect(() => {
    ...
    if (isPunchedIn && profile?.email) {
      ...
      fetch('https://script.google.com/macros/s/AKfycbznQT8_KQrusju3uIAiGc5xlUcTh40cNht84Kw6Xa5ioJBniAZmRQHwJlPTspuF-HYv/exec', {
  ...
  const fetchMessages = useCallback(async () => {
    try {
      const url = 'https://script.google.com/macros/s/AKfycbznQT8_KQrusju3uIAiGc5xlUcTh40cNht84Kw6Xa5ioJBniAZmRQHwJlPTspuF-HYv/exec'
  ...
  const fetchSyncedTasks = async () => {
    ...
    try {
      const url = `https://script.google.com/macros/s/AKfycbznQT8_KQrusju3uIAiGc5xlUcTh40cNht84Kw6Xa5ioJBniAZmRQHwJlPTspuF-HYv/exec?action=get_tasks&t=${Date.now()}`
      const res = await fetch(url)
  ...
  const fetchTeam = async () => {
    ...
    try {
      const url = `https://script.google.com/macros/s/AKfycbznQT8_KQrusju3uIAiGc5xlUcTh40cNht84Kw6Xa5ioJBniAZmRQHwJlPTspuF-HYv/exec?action=get_team&t=${Date.now()}`
      const res = await fetch(url)
  ...
  const fetchClients = async () => {
    try {
      const url = `https://script.google.com/macros/s/AKfycbznQT8_KQrusju3uIAiGc5xlUcTh40cNht84Kw6Xa5ioJBniAZmRQHwJlPTspuF-HYv/exec?action=get_clients&t=${Date.now()}`
      const res = await fetch(url)
  ...
  const fetchActivities = async () => {
    try {
      const url = `https://script.google.com/macros/s/AKfycbznQT8_KQrusju3uIAiGc5xlUcTh40cNht84Kw6Xa5ioJBniAZmRQHwJlPTspuF-HYv/exec?action=get_activities&t=${Date.now()}`
      const res = await fetch(url)
      if (res.ok) {
        const text = await res.text()
        try {
