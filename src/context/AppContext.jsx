...
export function AppProvider({ children }) {
  ...
  useEffect(() => {
    if (profile?.email) {
      ...
      const handleBeforeUnload = () => {
        ...
        try {
          const url = 'https://script.google.com/macros/s/AKfycbyEiCRlSnUjR1-t-grKwSQ72nif78DOzDajp1f-jGuYUjSKnV6OxGOMe_PEe58czBky/exec'
  ...
  const fetchSyncedTasks = async () => {
    ...
    try {
      const url = `https://script.google.com/macros/s/AKfycbyEiCRlSnUjR1-t-grKwSQ72nif78DOzDajp1f-jGuYUjSKnV6OxGOMe_PEe58czBky/exec?action=get_tasks&t=${Date.now()}`
      const res = await fetch(url)
  ...
  const fetchTeam = async () => {
    ...
    try {
      const url = `https://script.google.com/macros/s/AKfycbyEiCRlSnUjR1-t-grKwSQ72nif78DOzDajp1f-jGuYUjSKnV6OxGOMe_PEe58czBky/exec?action=get_team&t=${Date.now()}`
      const res = await fetch(url)
  ...
  const fetchClients = async () => {
    try {
      const url = `https://script.google.com/macros/s/AKfycbyEiCRlSnUjR1-t-grKwSQ72nif78DOzDajp1f-jGuYUjSKnV6OxGOMe_PEe58czBky/exec?action=get_clients&t=${Date.now()}`
      const res = await fetch(url)
  ...
  const fetchActivities = async () => {
    try {
      const url = `https://script.google.com/macros/s/AKfycbyEiCRlSnUjR1-t-grKwSQ72nif78DOzDajp1f-jGuYUjSKnV6OxGOMe_PEe58czBky/exec?action=get_activities&t=${Date.now()}`
      const res = await fetch(url)
      if (res.ok) {
        const text = await res.text()
        try {
