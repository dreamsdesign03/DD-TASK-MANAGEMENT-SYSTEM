...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-[100dvh] bg-[#F8FAFC] text-slate-900 font-sans overflow-x-hidden selection:bg-primary/20 selection:text-primary">
      ...
      <main className="relative z-10 flex flex-col items-center px-6 pt-32 md:pt-48 pb-24 max-w-7xl mx-auto w-full">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-16 w-full">
          <div className="flex-1 flex flex-col items-start text-left max-w-2xl">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white border border-slate-200 text-slate-600 font-medium text-xs mb-8 shadow-sm">
              <span className="w-1.5 h-1.5 rounded-full bg-green-500 animate-pulse" />
              Dreamsdesk Setup 0.0.0 is live
            </div>

            <h1 className="text-5xl sm:text-6xl md:text-[5.5rem] font-extrabold tracking-tight leading-[1.05] mb-6 text-slate-900">
              The ultimate <br />
            ...
            <p className="text-lg md:text-xl text-slate-600 mb-10 leading-relaxed font-normal max-w-lg">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 w-full">
              <a 
                href={DOWNLOAD_URL}
                className="w-full sm:w-auto px-8 py-4 bg-primary text-white rounded-xl font-semibold text-base hover:bg-primary/90 transition-all shadow-[0_8px_20px_-6px_rgba(var(--color-primary),0.5)] flex items-center justify-center gap-3 active:scale-95"
              >
              ...
              <button 
                onClick={() => navigate('/login')}
                className="w-full sm:w-auto px-8 py-4 bg-white text-slate-700 rounded-xl font-semibold text-base border border-slate-200 hover:bg-slate-50 transition-all flex items-center justify-center gap-2 shadow-sm"
              >
                Open in Browser
            ...
            <p className="mt-4 text-xs text-slate-400 font-medium tracking-wide">WINDOWS 10/11 • 64-BIT</p>
          </div>
          ...
          <div className="flex-1 w-full max-w-2xl relative">
            ...
            <div className="relative rounded-[1.5rem] bg-white p-2 border border-slate-200 shadow-2xl shadow-slate-200/50 transform rotate-1 hover:rotate-0 hover:scale-[1.01] transition-all duration-500">
              <div className="rounded-xl bg-[#FAFAFA] overflow-hidden border border-slate-100 flex flex-col h-[400px]">
                {/* Mockup Header */}
                <div className="h-12 border-b border-slate-200 flex items-center px-4 gap-2 bg-white">
                  <div className="w-2.5 h-2.5 rounded-full bg-slate-300" />
                  <div className="w-2.5 h-2.5 rounded-full bg-slate-300" />
                  <div className="w-2.5 h-2.5 rounded-full bg-slate-300" />
                  <div className="ml-4 h-6 w-48 bg-slate-100 rounded-md" />
                </div>
                {/* Mockup Content */}
                <div className="flex-1 p-6 flex gap-6 relative overflow-hidden bg-slate-50">
                  {/* Sidebar */}
                  ...
                  <div className="flex-1 flex flex-col gap-4">
                    <div className="w-1/3 h-6 rounded bg-slate-200" />
                    <div className="w-full h-32 rounded-xl bg-white border border-slate-200 shadow-sm p-4 flex flex-col gap-3">
                      <div className="w-1/2 h-4 rounded bg-slate-100" />
                      <div className="w-3/4 h-4 rounded bg-slate-100" />
                      <div className="w-1/4 h-4 rounded bg-primary/10 mt-auto" />
                    </div>
                    <div className="w-full h-32 rounded-xl bg-white border border-slate-200 shadow-sm p-4 flex flex-col gap-3">
                      <div className="w-1/2 h-4 rounded bg-slate-100" />
                      <div className="w-3/4 h-4 rounded bg-slate-100" />
